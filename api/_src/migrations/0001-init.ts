// Extracted from db.ts's inline DDL — the schema as of the first real
// migration. Everything is idempotent (IF NOT EXISTS / IF NOT EXISTS-style
// ALTERs) so it applies cleanly on both fresh and existing databases.
export const sql = `
