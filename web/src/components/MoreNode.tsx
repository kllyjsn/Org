...
function MoreNode({ data }: NodeProps<MoreNodeData>) {
  return (
    <button
      ...
      className="nodrag flex h-[52px] min-h-[44px] w-full cursor-pointer items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-slate-300 bg-white/60 text-xs font-semibold text-slate-500 transition hover:border-[#5b4cf0] hover:bg-[#f5f4ff] hover:text-[#5b4cf0]"
    >
